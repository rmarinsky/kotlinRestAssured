...
public class JMessageAssert extends AbstractAssert<JMessageAssert, JMessage> {
    ...
    /**
     * An entry point for JMessageAssert to follow AssertJ standard <code>assertThat()</code>
     * statements.<br> With a static import, one can write directly: <code>assertThat(myJMessageResponse)</code>
