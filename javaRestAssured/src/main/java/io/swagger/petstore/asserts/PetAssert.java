 ...
 */
public class PetAssert extends AbstractAssert<PetAssert, JPet> {

  /**
   * Creates a new <code>{@link PetAssert}</code> to make assertions on actual JPet.
   * @param actual the JPet we want to make assertions on.
   */
  public PetAssert(JPet actual) {
   ...
   */
  public static PetAssert assertThat(JPet actual) {
   ...
   */
  public PetAssert hasCategory(JCategory category) {
   ...
   */
  public PetAssert hasTags(JTag... tags) {
    // check that actual JPet we want to make assertions on is not null.
    isNotNull();
   ...
   * @throws AssertionError if the actual JPet's tags does not contain all given JTag elements.
   */
  public PetAssert hasOnlyTags(JTag... tags) {
    // check that actual JPet we want to make assertions on is not null.
    isNotNull();
   ...
   */
  public PetAssert doesNotHaveTags(JTag... tags) {
    // check that actual JPet we want to make assertions on is not null.
    isNotNull();
