 ...
 */
public class TagAssert extends AbstractAssert<TagAssert, JTag> {

  /**
   * Creates a new <code>{@link TagAssert}</code> to make assertions on actual JTag.
   * @param actual the JTag we want to make assertions on.
   */
  public TagAssert(JTag actual) {
    super(actual, TagAssert.class);
  }

  /**
   * An entry point for JTagAssert to follow AssertJ standard <code>assertThat()</code> statements.<br>
   * With a static import, one can write directly: <code>assertThat(myJTag)</code> and get specific assertion with code completion.
   * @param actual the JTag we want to make assertions on.
   * @return a new <code>{@link TagAssert}</code>
   */
  public static TagAssert assertThat(JTag actual) {
