...
public class JPetAssert extends AbstractAssert<JPetAssert, JPet> {
    ...
    /**
     * An entry point for JPetAssert to follow AssertJ standard <code>assertThat()</code>
     * statements.<br> With a static import, one can write directly: <code>assertThat(myJPet)</code>
     ...
     * @return this assertion object.
     * @throws AssertionError if the actual JPet's photoUrls does not contain all given String
     * elements.
     */
    ...
    /**
     * Verifies that the actual JPet's photoUrls contains <b>only<b> the given String elements and
    ...
    /**
     * Verifies that the actual JPet's tags contains <b>only<b> the given JTag elements and nothing
